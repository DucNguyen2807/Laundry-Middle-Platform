...
<html>
    ...
    <body>
        ...
        <div class="container mt-4" style="margin-left: 140px;">
            ...
            <!-- Search form -->
            <form action="ViewHistoryController" method="post" class="mb-3">
                <div class="input-group">
                    <input type="text" name="txtSearchOrder" class="form-control" placeholder="Tìm đơn hàng...">
                    <button type="submit" value="ViewOrder" name="btAction" class="btn btn-primary">Tìm kiếm</button>
                </div>
            </form>

            <form action="MainController" method="post">
                <button value="ViewOrder" name="btAction"  class="btn btn-primary">Xem tất cả</button>
                <input type="hidden" name="txtSearchOrder" value="" />
            </form>
            ...
            <table class="table table-striped">
                ...
                <form action="MainController">
                    <tr>
                        <td><%= ++count%></td>
                        <td><%= (!ord.getAddressCus().equalsIgnoreCase("NULL") ) ? ord.getAddressCus() : ""%></td>
                        <td><%= (!ord.getAddressSto().equalsIgnoreCase("NULL")) ? ord.getAddressSto() : ""%></td>
                        <td><%= (!ord.getCustomerName().equalsIgnoreCase("NULL")) ? ord.getCustomerName() : ""%></td>
                        <td><%= (!ord.getStoreName().equalsIgnoreCase("NULL")) ? ord.getStoreName().toUpperCase() : ""%></td>
                        <td><%= (!ord.getDateDesired().equalsIgnoreCase("NULL")) ? ord.getDateDesired() : ""%></td>
                        <td><%= (!ord.getTimeDesired().equalsIgnoreCase("NULL")) ? ord.getTimeDesired() : ""%></td>
                        <td><%= (!ord.getDateComplete().equalsIgnoreCase("NULL")) ? ord.getDateComplete() : ""%></td>
                        <td><%= (!ord.getTimeComplete().equalsIgnoreCase("NULL")) ? ord.getTimeComplete() : ""%></td>
                        <td><%= (!ord.getStaffName().equalsIgnoreCase("NULL")) ? ord.getStaffName() : ""%></td>
                        <td><%= (!ord.getStOrderDetail().equalsIgnoreCase("NULL")) ? ord.getStOrderDetail() : ""%></td>
                    </tr>
