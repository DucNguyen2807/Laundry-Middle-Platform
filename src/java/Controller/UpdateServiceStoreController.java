 ...
 * @author acer
 */
@WebServlet(name = "UpdateServiceStoreController", urlPatterns = {"/UpdateServiceStoreController"})
public class UpdateServiceStoreController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdateServiceStoreController.class.getName()).log(Level.SEVERE, null, ex);
